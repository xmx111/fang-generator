...
import com.ufo.${project_name}.center.service.${model_name}Service;
...
public class ${model_name}Action extends BaseTemplateAction<${model_name}, ${id_type}> {
    ...
    @ResponseBody
    public Object queryForPage(Integer page, Integer rows) {
    ...
    @ResponseBody
    public Object add(${model_name} dto) {
        return add(dto);
    }

    @RequestMapping("modify.do")
    @ResponseBody
    public Object modify(${model_name} dto) {
        return modify(dto);
    }
